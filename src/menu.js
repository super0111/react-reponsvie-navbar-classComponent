        ...
        <div className="burgerIcon" onClick={() => this.onclick()}>
            { aaa?
                <div className="aaa">
                    ...
                    <div className="more-icon"><i class="fas fa-angle-up"></i></div> 
                </div>
                : 
                <div className="aaa">
                    <div className="more-text">More</div>
                    <div className="more-icon"> <i class="fas fa-angle-down"></i></div>
                </div>
            }
        </div>
      ) : null;
...
export default Menu
// React.render(<ResponsiveNavBar />, document.getElementById("app"));
